...
public class SaleOrderService : IDynamicApiController, ITransient
{
    private readonly SqlSugarRepository<SaleOrder> _rep;
    public SaleOrderService(SqlSugarRepository<SaleOrder> rep)
    {
        _rep = rep;
    }
    ...
    public async Task<SqlSugarPagedList<SaleOrderOutput>> Page(SaleOrderInput input)
    {
    ...
    public async Task<long> Add(AddSaleOrderInput input)
    {
        var entity = input.Adapt<SaleOrder>();
    ...
    public async Task Delete(DeleteSaleOrderInput input)
    {
    ...
    public async Task Update(UpdateSaleOrderInput input)
    {
        var entity = input.Adapt<SaleOrder>();
    ...
    public async Task<SaleOrder> Detail([FromQuery] QueryByIdSaleOrderInput input)
    {
    ...
    public async Task<List<SaleOrderOutput>> List([FromQuery] SaleOrderInput input)
    {
        return await _rep.AsQueryable().Select<SaleOrderOutput>().ToListAsync();
    }
