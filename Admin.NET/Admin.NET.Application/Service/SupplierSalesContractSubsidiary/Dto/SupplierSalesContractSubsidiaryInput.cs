...
namespace Admin.NET.Application;
    ...
    /// 供应商销售合同从表基础输入参数
    /// </summary>
    public class SupplierSalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主表id
        /// </summary>
    ...
    /// 供应商销售合同从表分页查询输入参数
    /// </summary>
    public class SupplierSalesContractSubsidiaryInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 供应商销售合同从表增加输入参数
    /// </summary>
    public class AddSupplierSalesContractSubsidiaryInput : SupplierSalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主表id
        /// </summary>
    ...
    /// 供应商销售合同从表删除输入参数
    /// </summary>
    public class DeleteSupplierSalesContractSubsidiaryInput : BaseIdInput
    {
    }
    ...
    /// 供应商销售合同从表更新输入参数
    /// </summary>
    public class UpdateSupplierSalesContractSubsidiaryInput : SupplierSalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 供应商销售合同从表主键查询输入参数
    /// </summary>
    public class QueryByIdSupplierSalesContractSubsidiaryInput : DeleteSupplierSalesContractSubsidiaryInput
    {
