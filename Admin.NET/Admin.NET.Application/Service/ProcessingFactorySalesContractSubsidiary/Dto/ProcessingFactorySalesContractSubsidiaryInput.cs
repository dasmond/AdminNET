...
namespace Admin.NET.Application;
    ...
    /// 加工厂合同从表基础输入参数
    /// </summary>
    public class ProcessingFactorySalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主表id
        /// </summary>
    ...
    /// 加工厂合同从表分页查询输入参数
    /// </summary>
    public class ProcessingFactorySalesContractSubsidiaryInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 加工厂合同从表增加输入参数
    /// </summary>
    public class AddProcessingFactorySalesContractSubsidiaryInput : ProcessingFactorySalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主表id
        /// </summary>
    ...
    /// 加工厂合同从表删除输入参数
    /// </summary>
    public class DeleteProcessingFactorySalesContractSubsidiaryInput : BaseIdInput
    {
    }
    ...
    /// 加工厂合同从表更新输入参数
    /// </summary>
    public class UpdateProcessingFactorySalesContractSubsidiaryInput : ProcessingFactorySalesContractSubsidiaryBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 加工厂合同从表主键查询输入参数
    /// </summary>
    public class QueryByIdProcessingFactorySalesContractSubsidiaryInput : DeleteProcessingFactorySalesContractSubsidiaryInput
    {
