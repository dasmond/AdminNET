...
namespace Admin.NET.Application;
    ...
    /// 供应商销售合同主表基础输入参数
    /// </summary>
    public class SupplierSalesContractMasterBaseInput
    {
        /// <summary>
        /// 编码
        /// </summary>
        ...
        /// 收货人id
        /// </summary>
        public virtual long ConsigneeId { get; set; }
    ...
    /// 供应商销售合同主表分页查询输入参数
    /// </summary>
    public class SupplierSalesContractMasterInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 供应商销售合同主表增加输入参数
    /// </summary>
    public class AddSupplierSalesContractMasterInput : SupplierSalesContractMasterBaseInput
    {
        /// <summary>
        /// 编码
        /// </summary>
        ...
        public override long ConsigneeId { get; set; }
    ...
    /// 供应商销售合同主表删除输入参数
    /// </summary>
    public class DeleteSupplierSalesContractMasterInput : BaseIdInput
    {
    }
    ...
    /// 供应商销售合同主表更新输入参数
    /// </summary>
    public class UpdateSupplierSalesContractMasterInput : SupplierSalesContractMasterBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 供应商销售合同主表主键查询输入参数
    /// </summary>
    public class QueryByIdSupplierSalesContractMasterInput : DeleteSupplierSalesContractMasterInput
    {
