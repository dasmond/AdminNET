...
namespace Admin.NET.Application;
    ...
    /// 销售价格报备表基础输入参数
    /// </summary>
    public class PriceReportingBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 销售价格报备表分页查询输入参数
    /// </summary>
    public class PriceReportingInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 销售价格报备表增加输入参数
    /// </summary>
    public class AddPriceReportingInput : PriceReportingBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 销售价格报备表删除输入参数
    /// </summary>
    public class DeletePriceReportingInput : BaseIdInput
    {
    }
    ...
    /// 销售价格报备表更新输入参数
    /// </summary>
    public class UpdatePriceReportingInput : PriceReportingBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 销售价格报备表主键查询输入参数
    /// </summary>
    public class QueryByIdPriceReportingInput : DeletePriceReportingInput
    {
