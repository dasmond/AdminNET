...
namespace Admin.NET.Application;
    ...
    /// 上位机程序基础输入参数
    /// </summary>
    public class UpperComputerProgramBaseInput
    {
        /// <summary>
        /// 商品id
        /// </summary>
    ...
    /// 上位机程序分页查询输入参数
    /// </summary>
    public class UpperComputerProgramInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 上位机程序增加输入参数
    /// </summary>
    public class AddUpperComputerProgramInput : UpperComputerProgramBaseInput
    {
        /// <summary>
        /// 商品id
        /// </summary>
    ...
    /// 上位机程序删除输入参数
    /// </summary>
    public class DeleteUpperComputerProgramInput : BaseIdInput
    {
    }
    ...
    /// 上位机程序更新输入参数
    /// </summary>
    public class UpdateUpperComputerProgramInput : UpperComputerProgramBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 上位机程序主键查询输入参数
    /// </summary>
    public class QueryByIdUpperComputerProgramInput : DeleteUpperComputerProgramInput
    {
