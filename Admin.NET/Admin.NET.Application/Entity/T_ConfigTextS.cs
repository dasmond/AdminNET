...
/// 选配2内容
/// </summary>
[SugarTable("T_ConfigTextS","选配2内容")]
public class T_ConfigTextS 
{
    /// <summary>
    /// 主键Id
    /// </summary>
    ...
    /// </summary>
    [Required]
    [SugarColumn(ColumnName = "选配2内容", ColumnDescription = "ConfigTextSName", Length = -1)]
    public string ConfigTextSName { get; set; }
