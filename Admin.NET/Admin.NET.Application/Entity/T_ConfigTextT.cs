...
/// 选配3内容
/// </summary>
[SugarTable("T_ConfigTextT","选配3内容")]
public class T_ConfigTextT 
{
    /// <summary>
    /// 主键Id
    /// </summary>
    ...
    /// </summary>
    [Required]
    [SugarColumn(ColumnName = "选配3内容", ColumnDescription = "ConfigTextTName", Length = -1)]
    public string ConfigTextTName { get; set; }
