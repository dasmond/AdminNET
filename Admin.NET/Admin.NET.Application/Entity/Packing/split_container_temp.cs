...
[SugarTable("split_container_temp", "容器缓存子表")]
[Tenant(MesExpandConst.ConfigId)]
public class split_container_temp : EntityBase
{
    /// <summary>
    /// 序号id
    /// </summary>
    [SugarColumn(ColumnDescription = "序号id")]
    ...
    /// 容器缓存id
    /// </summary>
    [SugarColumn(ColumnDescription = "容器缓存id")]
