...
namespace Admin.NET.Core
{
    ...
    public class SysUserSeedData : ISqlSugarEntitySeedData<SysUser>
    {
        ...
        public IEnumerable<SysUser> HasData()
        {
            return new[]
            {
                new SysUser{ Id=252885263000000, UserName="vben", Password="e10adc3949ba59abbe56e057f20f883e", NickName="超级管理员", RealName="超级管理员", Phone="18020030720", Birthday=DateTime.Parse("1986-06-28"), Sex=GenderEnum.Male, UserType=UserTypeEnum.SuperAdmin, Remark="超级管理员", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
