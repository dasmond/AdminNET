...
public class SysDataResourceSeedData : ISqlSugarEntitySeedData<SysDataResource>
{
    ...
    public IEnumerable<SysDataResource> HasData()
    {
        return new[]
        {
            ...
            new SysDataResource{ Id=243849612111001, Pid=243849612110001, Name="联想笔记本",Value="联想笔记本", Code="1001001001", CreateTime=DateTime.Parse("2022-05-30 00:00:00"), Remark=""},
            new SysDataResource{ Id=243849612111002, Pid=243849612110001, Name="华为笔记本",Value="华为笔记本", Code="1001001002", CreateTime=DateTime.Parse("2022-05-30 00:00:00"), Remark=""},
        };
    }
