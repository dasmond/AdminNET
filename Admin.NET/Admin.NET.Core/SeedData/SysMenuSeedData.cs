    ...
    public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
    {
        ...
        public IEnumerable<SysMenu> HasData()
        {
            return new[]
            {
                ...
                new SysMenu{ Id=252885263003900, Pid=0, Title="微服务", Path="/micro", Name="micro", Component="LAYOUT", Redirect="", Icon="ant-design:carry-out-outlined", Type=MenuTypeEnum.Dir, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=300 },
                new SysMenu{ Id=252885263003910, Pid=252885263003900, Title="链路追踪", Path="http://localhost:9411", Name="zipkin", Component="IFrame", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
                new SysMenu{ Id=252885263003911, Pid=252885263003900, Title="消息队列", Path="http://localhost:15672", Name="rabbitmq", Component="IFrame", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
                new SysMenu{ Id=252885263003912, Pid=252885263003900, Title="数据库管理", Path="http://localhost:5050", Name="pgadmin", Component="IFrame", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
                new SysMenu{ Id=252885263003913, Pid=252885263003900, Title="日志服务器", Path="http://localhost:5380", Name="req", Component="IFrame", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
