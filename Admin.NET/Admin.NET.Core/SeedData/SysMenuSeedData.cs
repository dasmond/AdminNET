...
public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
{
    ...
    public IEnumerable<SysMenu> HasData()
    {
        return new[]
        {
            ...
            new SysMenu{ Id=1310000001320, Pid=1310000000311, Title="同步授权", Permission="sysTenant:syncGrantMenu", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000001321, Pid=1310000000311, Title="切换租户", Permission="sysTenant:changeTenant", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000001322, Pid=1310000000311, Title="进入租管端", Permission="sysTenant:goTenant", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
