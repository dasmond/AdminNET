    ...
    public partial class v100 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id主键"),
                    Uuid = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "UUID"),
                    ...
                    Gender = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true, comment: "性别"),
                    Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "电话"),
                    Email = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "邮箱"),
                    Location = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "位置"),
                    Blog = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "用户网址"),
                    Company = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "所在公司"),
                    Source = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "用户来源"),
                    Remark = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "备注"),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, comment: "创建时间"),
                    UpdatedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, comment: "更新时间"),
                    CreatedUserId = table.Column<long>(type: "bigint", nullable: true, comment: "创建者Id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cron = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "Cron表达式"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 142307070918778L, "system", "code_gen_gen", "gen/codeGenerate/index", null, null, null, null, false, null, "代码生成", 0, null, 142307070918776L, "[0],[142307070918776],", null, null, "/codeGenerate/index", 100, 0, 1, null, null, null, "Y", 1 },
                    { 142307070918779L, "system", "low_code", "gen/lowCode/index", null, null, null, null, false, null, "低代码管理", 0, null, 142307070918776L, "[0],[142307070918776],", null, null, "/lowCode/index", 100, 0, 1, null, null, null, "Y", 1 },
                    { 142307070918780L, "system", "code_gen_assembly", "gen/codeGenerate/assembly", null, null, null, null, false, null, "组件管理", 0, null, 142307070918776L, "[0],[142307070918776],", null, null, "/codeGenerate/assembly", 100, 0, 1, null, null, null, "Y", 1 },
