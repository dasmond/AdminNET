...
public class SupplierPriceReportingService : IDynamicApiController, ITransient
{
    private readonly SqlSugarRepository<SupplierPriceReporting> _rep;
    public SupplierPriceReportingService(SqlSugarRepository<SupplierPriceReporting> rep)
    {
        _rep = rep;
    }
    ...
    public async Task<SqlSugarPagedList<SupplierPriceReportingOutput>> Page(SupplierPriceReportingInput input)
    {
        var query = _rep.AsQueryable()
            ...
            .Select<SupplierPriceReportingOutput>();
    ...
    public async Task<long> Add(AddSupplierPriceReportingInput input)
    {
        var entity = input.Adapt<SupplierPriceReporting>();
    ...
    public async Task Delete(DeleteSupplierPriceReportingInput input)
    {
    ...
    public async Task Update(UpdateSupplierPriceReportingInput input)
    {
        var entity = input.Adapt<SupplierPriceReporting>();
    ...
    public async Task<SupplierPriceReporting> Detail([FromQuery] QueryByIdSupplierPriceReportingInput input)
    {
    ...
    public async Task<List<SupplierPriceReportingOutput>> List([FromQuery] SupplierPriceReportingInput input)
    {
        return await _rep.AsQueryable().Select<SupplierPriceReportingOutput>().ToListAsync();
    }
