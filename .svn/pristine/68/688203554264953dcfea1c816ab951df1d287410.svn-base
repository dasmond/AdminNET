...
namespace Admin.NET.Application;
    ...
    /// 加工拒收订单基础输入参数
    /// </summary>
    public class ProcessingRejectionOrderBaseInput
    {
        /// <summary>
        /// 合同id
        /// </summary>
    ...
    /// 加工拒收订单分页查询输入参数
    /// </summary>
    public class ProcessingRejectionOrderInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 加工拒收订单增加输入参数
    /// </summary>
    public class AddProcessingRejectionOrderInput : ProcessingRejectionOrderBaseInput
    {
        /// <summary>
        /// 合同id
        /// </summary>
    ...
    /// 加工拒收订单删除输入参数
    /// </summary>
    public class DeleteProcessingRejectionOrderInput : BaseIdInput
    {
    }
    ...
    /// 加工拒收订单更新输入参数
    /// </summary>
    public class UpdateProcessingRejectionOrderInput : ProcessingRejectionOrderBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 加工拒收订单主键查询输入参数
    /// </summary>
    public class QueryByIdProcessingRejectionOrderInput : DeleteProcessingRejectionOrderInput
    {
