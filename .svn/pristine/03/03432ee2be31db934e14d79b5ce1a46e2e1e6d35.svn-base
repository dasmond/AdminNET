...
namespace Admin.NET.Application;
    ...
    /// 供应商入库订单详情基础输入参数
    /// </summary>
    public class SupplierOrderDetailsBaseInput
    {
        /// <summary>
        /// 订单id
        /// </summary>
    ...
    /// 供应商入库订单详情分页查询输入参数
    /// </summary>
    public class SupplierOrderDetailsInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 供应商入库订单详情增加输入参数
    /// </summary>
    public class AddSupplierOrderDetailsInput : SupplierOrderDetailsBaseInput
    {
        /// <summary>
        /// 订单id
        /// </summary>
    ...
    /// 供应商入库订单详情删除输入参数
    /// </summary>
    public class DeleteSupplierOrderDetailsInput : BaseIdInput
    {
    }
    ...
    /// 供应商入库订单详情更新输入参数
    /// </summary>
    public class UpdateSupplierOrderDetailsInput : SupplierOrderDetailsBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 供应商入库订单详情主键查询输入参数
    /// </summary>
    public class QueryByIdSupplierOrderDetailsInput : DeleteSupplierOrderDetailsInput
    {
