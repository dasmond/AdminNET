...
public class PriceReportingService : IDynamicApiController, ITransient
{
    private readonly SqlSugarRepository<PriceReporting> _rep;
    public PriceReportingService(SqlSugarRepository<PriceReporting> rep)
    {
        _rep = rep;
    }
    ...
    public async Task<SqlSugarPagedList<PriceReportingOutput>> Page(PriceReportingInput input)
    {
    ...
    public async Task<long> Add(AddPriceReportingInput input)
    {
        var entity = input.Adapt<PriceReporting>();
    ...
    public async Task Delete(DeletePriceReportingInput input)
    {
    ...
    public async Task Update(UpdatePriceReportingInput input)
    {
        var entity = input.Adapt<PriceReporting>();
    ...
    public async Task<PriceReporting> Detail([FromQuery] QueryByIdPriceReportingInput input)
    {
    ...
    public async Task<List<PriceReportingOutput>> List([FromQuery] PriceReportingInput input)
    {
        return await _rep.AsQueryable().Select<PriceReportingOutput>().ToListAsync();
    }
