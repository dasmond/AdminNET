				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="数量" prop="quantity">
							<el-input v-model="ruleForm.quantity" placeholder="请输入数量" maxlength="18" show-word-limit clearable />
							
						</el-form-item>
						
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="超出数量" prop="exceedQuantity">
							<el-input v-model="ruleForm.exceedQuantity" placeholder="请输入超出数量" maxlength="18" show-word-limit clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="分类" prop="grouping">
							<el-input v-model="ruleForm.grouping" placeholder="请输入分类" maxlength="19" show-word-limit clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="类型" prop="typesOf">
							<el-input v-model="ruleForm.typesOf" placeholder="请输入类型" maxlength="19" show-word-limit clearable />
...
<script lang="ts" setup>
	...
	import { addProcessOrder, updateProcessOrder, detailProcessOrder } from "/@/api/main/processOrder";
	...
	const rules = ref<FormRules>({
		...
		exceedQuantity: [{required: true, message: '请输入超出数量！', trigger: 'blur',},],
		...
		grouping: [{required: true, message: '请输入分类！', trigger: 'blur',},],
	...
	const openDialog = async (row: any) => {
		...
		if (rowData.id)
			ruleForm.value = (await detailProcessOrder(rowData.id)).data.result;
		else
		...
		ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
			if (isValid) {
				...
				if (ruleForm.value.id == undefined || ruleForm.value.id == null || ruleForm.value.id == "" || ruleForm.value.id == 0) {
					await addProcessOrder(values);
				} else {
					await updateProcessOrder(values);
				}
				closeDialog();
			} else {
				ElMessage({
