...
public class RouteMenuOutput
{
    ...
    /// 
    /// </summary>
    public List<MenuOutput> Routes { get; set; } = new List<MenuOutput>();
}
...
public class SysMenuMapper : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.ForType<SysMenu, MenuOutput>()
            ...
            .Map(t => t.Meta.HideInMenu, o => o.IsHide)
            .Map(t => t.Meta.KeepAlive, o => o.IsKeepAlive)
            .Map(t => t.Meta.Href, o => o.OutLink,w=>!w.IsIframe)
            .Map(t => t.Props.Url, o => o.OutLink,w=>w.IsIframe);
    }
}