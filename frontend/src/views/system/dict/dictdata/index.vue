    ...
    <a-card :bordered="false">
      <s-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" v-if="hasPerm('sysDictData:edit') & hasPerm('sysDictData:delete')"/>
          <a @click="$refs.relationIndex.index(record, dictType)">关联</a>
        </span>
      </s-table>
      <add-form ref="addForm" @ok="handleOk" />
      <edit-form ref="editForm" @ok="handleOk" />
      <relation-index ref="relationIndex" @ok="handleOk" />
    </a-card>
  </a-modal>
</template>
<script>
  ...
  import relationIndex from '../dictrelation/index'
  export default {
    components: {
      XCard,
      STable,
