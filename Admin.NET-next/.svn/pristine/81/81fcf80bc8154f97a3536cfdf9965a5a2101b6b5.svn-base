		...
		<el-dialog v-model="isShowDialog" :width="800" draggable="">
			...
			<el-form :model="ruleForm" ref="ruleFormRef" label-width="auto" :rules="rules">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="收货人id" prop="consignee">
							<el-input v-model="ruleForm.consignee" placeholder="请输入收货人id" maxlength="19" show-word-limit clearable />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="是否允许回签" prop="allowSignatureBack">
							<el-switch v-model="ruleForm.allowSignatureBack" active-text="是" inactive-text="否" />
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="是否送样" prop="sampleDelivery">
							<el-switch v-model="ruleForm.sampleDelivery" active-text="是" inactive-text="否" />
...
<script lang="ts" setup>
	...
	import { addSalesContractMaster, updateSalesContractMaster, detailSalesContractMaster } from "/@/api/main/salesContractMaster";
	...
	const rules = ref<FormRules>({
		...
		consignee: [{required: true, message: '请输入收货人id！', trigger: 'blur',},],
	...
	const openDialog = async (row: any) => {
		...
		if (rowData.id)
			ruleForm.value = (await detailSalesContractMaster(rowData.id)).data.result;
		else
		...
		ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
			if (isValid) {
				...
				if (ruleForm.value.id == undefined || ruleForm.value.id == null || ruleForm.value.id == "" || ruleForm.value.id == 0) {
					await addSalesContractMaster(values);
				} else {
					await updateSalesContractMaster(values);
				}
				closeDialog();
			} else {
				ElMessage({
