...
namespace Admin.NET.Application;
    ...
    /// 加工厂联系人资料基础输入参数
    /// </summary>
    public class ProcessingFactoryContactsBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 加工厂联系人资料分页查询输入参数
    /// </summary>
    public class ProcessingFactoryContactsInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 加工厂联系人资料增加输入参数
    /// </summary>
    public class AddProcessingFactoryContactsInput : ProcessingFactoryContactsBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 加工厂联系人资料删除输入参数
    /// </summary>
    public class DeleteProcessingFactoryContactsInput : BaseIdInput
    {
    }
    ...
    /// 加工厂联系人资料更新输入参数
    /// </summary>
    public class UpdateProcessingFactoryContactsInput : ProcessingFactoryContactsBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 加工厂联系人资料主键查询输入参数
    /// </summary>
    public class QueryByIdProcessingFactoryContactsInput : DeleteProcessingFactoryContactsInput
    {
