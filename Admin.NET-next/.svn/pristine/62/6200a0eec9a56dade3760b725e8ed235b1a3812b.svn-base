...
namespace Admin.NET.Application;
    ...
    /// 供应商价格报备表基础输入参数
    /// </summary>
    public class SupplierPriceReportingBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 供应商价格报备表分页查询输入参数
    /// </summary>
    public class SupplierPriceReportingInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 供应商价格报备表增加输入参数
    /// </summary>
    public class AddSupplierPriceReportingInput : SupplierPriceReportingBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 供应商价格报备表删除输入参数
    /// </summary>
    public class DeleteSupplierPriceReportingInput : BaseIdInput
    {
    }
    ...
    /// 供应商价格报备表更新输入参数
    /// </summary>
    public class UpdateSupplierPriceReportingInput : SupplierPriceReportingBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 供应商价格报备表主键查询输入参数
    /// </summary>
    public class QueryByIdSupplierPriceReportingInput : DeleteSupplierPriceReportingInput
    {
