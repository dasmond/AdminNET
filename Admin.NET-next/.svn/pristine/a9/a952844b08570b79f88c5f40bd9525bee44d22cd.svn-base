  ...
  <div class="inventory-container">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="仓库id">
              <el-input v-model="queryParams.storageId" clearable="" placeholder="请输入仓库id"/>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="现有数量">
              <el-input v-model="queryParams.onhandNumber" clearable="" placeholder="请输入现有数量"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="采购在途数量">
              <el-input v-model="queryParams.procureNumber" clearable="" placeholder="请输入采购在途数量"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="加工在途">
              <el-input v-model="queryParams.processingIntransit" clearable="" placeholder="请输入加工在途"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="冻结量">
              <el-input v-model="queryParams.frozenNumber" clearable="" placeholder="请输入冻结量"/>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column prop="storageId" label="仓库id" width="140"  show-overflow-tooltip="" />
        ...
        <el-table-column prop="onhandNumber" label="现有数量" width="140"  show-overflow-tooltip="" />
        <el-table-column prop="procureNumber" label="采购在途数量" width="90"  show-overflow-tooltip="" />
        <el-table-column prop="processingIntransit" label="加工在途" width="140"  show-overflow-tooltip="" />
        <el-table-column prop="frozenNumber" label="冻结量" width="140"  show-overflow-tooltip="" />
...
<script lang="ts" setup="" name="inventory">
  ...
  const openAddInventory = () => {
    editInventoryTitle.value = '添加库存表';
    editDialogRef.value.openDialog({});
  };

  // 打开打印页面
  const openPrintInventory = async (row: any) => {
    printInventoryTitle.value = '打印库存表';
  }
  
  // 打开编辑页面
  const openEditInventory = (row: any) => {
    editInventoryTitle.value = '编辑库存表';
