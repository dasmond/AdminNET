...
<script lang="ts" setup>
	...
	import { addSaleOrder, updateSaleOrder, detailSaleOrder } from "/@/api/main/saleOrder";
	...
	const openDialog = async (row: any) => {
		...
		if (rowData.id)
			ruleForm.value = (await detailSaleOrder(rowData.id)).data.result;
		else
