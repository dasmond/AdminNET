...
namespace Admin.NET.Application;
    ...
    /// BOM资料表明细表基础输入参数
    /// </summary>
    public class BomDetailsBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// BOM资料表明细表分页查询输入参数
    /// </summary>
    public class BomDetailsInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// BOM资料表明细表增加输入参数
    /// </summary>
    public class AddBomDetailsInput : BomDetailsBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// BOM资料表明细表删除输入参数
    /// </summary>
    public class DeleteBomDetailsInput : BaseIdInput
    {
    }
    ...
    /// BOM资料表明细表更新输入参数
    /// </summary>
    public class UpdateBomDetailsInput : BomDetailsBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// BOM资料表明细表主键查询输入参数
    /// </summary>
    public class QueryByIdBomDetailsInput : DeleteBomDetailsInput
    {
