...
namespace Admin.NET.Application;
    ...
    /// 销售订单详情基础输入参数
    /// </summary>
    public class SaleOrderDetailsBaseInput
    {
        /// <summary>
        /// 订单id
        /// </summary>
    ...
    /// 销售订单详情分页查询输入参数
    /// </summary>
    public class SaleOrderDetailsInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 销售订单详情增加输入参数
    /// </summary>
    public class AddSaleOrderDetailsInput : SaleOrderDetailsBaseInput
    {
        /// <summary>
        /// 订单id
        /// </summary>
    ...
    /// 销售订单详情删除输入参数
    /// </summary>
    public class DeleteSaleOrderDetailsInput : BaseIdInput
    {
    }
    ...
    /// 销售订单详情更新输入参数
    /// </summary>
    public class UpdateSaleOrderDetailsInput : SaleOrderDetailsBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 销售订单详情主键查询输入参数
    /// </summary>
    public class QueryByIdSaleOrderDetailsInput : DeleteSaleOrderDetailsInput
    {
