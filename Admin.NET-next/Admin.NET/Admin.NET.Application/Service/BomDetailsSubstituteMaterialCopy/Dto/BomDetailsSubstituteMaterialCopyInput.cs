...
namespace Admin.NET.Application;
    ...
    /// BOM详情代替料表副本基础输入参数
    /// </summary>
    public class BomDetailsSubstituteMaterialCopyBaseInput
    {
        /// <summary>
        /// Bom主表id
        /// </summary>
    ...
    /// BOM详情代替料表副本分页查询输入参数
    /// </summary>
    public class BomDetailsSubstituteMaterialCopyInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// BOM详情代替料表副本增加输入参数
    /// </summary>
    public class AddBomDetailsSubstituteMaterialCopyInput : BomDetailsSubstituteMaterialCopyBaseInput
    {
        /// <summary>
        /// Bom主表id
        /// </summary>
    ...
    /// BOM详情代替料表副本删除输入参数
    /// </summary>
    public class DeleteBomDetailsSubstituteMaterialCopyInput : BaseIdInput
    {
    }
    ...
    /// BOM详情代替料表副本更新输入参数
    /// </summary>
    public class UpdateBomDetailsSubstituteMaterialCopyInput : BomDetailsSubstituteMaterialCopyBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// BOM详情代替料表副本主键查询输入参数
    /// </summary>
    public class QueryByIdBomDetailsSubstituteMaterialCopyInput : DeleteBomDetailsSubstituteMaterialCopyInput
    {
