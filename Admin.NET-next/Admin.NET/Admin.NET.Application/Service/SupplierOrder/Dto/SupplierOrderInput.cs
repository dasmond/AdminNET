...
namespace Admin.NET.Application;
    ...
    /// 供应商订单基础输入参数
    /// </summary>
    public class SupplierOrderBaseInput
    {
        /// <summary>
        /// 合同id
        /// </summary>
        ...
        /// 超出数量
        /// </summary>
        public virtual decimal ExceedQuantity { get; set; }
    ...
    /// 供应商订单分页查询输入参数
    /// </summary>
    public class SupplierOrderInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 供应商订单增加输入参数
    /// </summary>
    public class AddSupplierOrderInput : SupplierOrderBaseInput
    {
        /// <summary>
        /// 合同id
        /// </summary>
        ...
        /// 超出数量
        /// </summary>
        [Required(ErrorMessage = "超出数量不能为空")]
        public override decimal ExceedQuantity { get; set; }
    ...
    /// 供应商订单删除输入参数
    /// </summary>
    public class DeleteSupplierOrderInput : BaseIdInput
    {
    }
    ...
    /// 供应商订单更新输入参数
    /// </summary>
    public class UpdateSupplierOrderInput : SupplierOrderBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 供应商订单主键查询输入参数
    /// </summary>
    public class QueryByIdSupplierOrderInput : DeleteSupplierOrderInput
    {
