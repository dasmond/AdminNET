...
namespace Admin.NET.Application;
    ...
    /// 加工厂资料基础输入参数
    /// </summary>
    public class ProcessingFactoryBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 加工厂资料分页查询输入参数
    /// </summary>
    public class ProcessingFactoryInput : BasePageInput
    {
        /// <summary>
        /// 关键字查询
        /// </summary>
    ...
    /// 加工厂资料增加输入参数
    /// </summary>
    public class AddProcessingFactoryInput : ProcessingFactoryBaseInput
    {
        /// <summary>
        /// 备注
        /// </summary>
    ...
    /// 加工厂资料删除输入参数
    /// </summary>
    public class DeleteProcessingFactoryInput : BaseIdInput
    {
    }
    ...
    /// 加工厂资料更新输入参数
    /// </summary>
    public class UpdateProcessingFactoryInput : ProcessingFactoryBaseInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 加工厂资料主键查询输入参数
    /// </summary>
    public class QueryByIdProcessingFactoryInput : DeleteProcessingFactoryInput
    {
