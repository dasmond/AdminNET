namespace Admin.NET.Core.Entity.WFH_Entity
{
    ...
    public class Customer : EntityBase
    {
        ...
        /// 客户所属人id
        /// </summary>
        [SugarColumn(ColumnDescription = "客户所属人id")]
        public long BelongtoId { get; set; }

        /// <summary>
        /// 上任业务员id
        /// </summary>
        [SugarColumn(ColumnDescription = "上任业务员id")]
        ...
        /// 助理分配时间
        /// </summary>
        [SugarColumn(ColumnDescription = "助理分配时间")]
        ...
        /// 客户类型
        /// </summary>
        [SugarColumn(ColumnDescription = "客户类型", Length = 255, IsNullable = true)]
        [MaxLength(255)]
