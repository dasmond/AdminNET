...
<script lang="ts" setup>
	...
	import { addSaleOfGoods, updateSaleOfGoods, detailSaleOfGoods } from "/@/api/main/saleOfGoods";
	...
	const openDialog = async (row: any) => {
		...
		if (rowData.id)
			ruleForm.value = (await detailSaleOfGoods(rowData.id)).data.result;
		else
