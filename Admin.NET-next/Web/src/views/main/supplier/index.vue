  ...
  <div class="supplier-container">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="供应商">
              <el-input v-model="queryParams.name" clearable="" placeholder="请输入供应商"/>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group>
                <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'supplier:page'"> 查询 </el-button>
              ...
              <el-button-group style="margin-left:20px">
                <el-button type="primary" icon="ele-Plus" @click="openAddSupplier" v-auth="'supplier:add'"> 新增 </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column prop="name" label="供应商" width="140"  show-overflow-tooltip="" />
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip="" v-if="auth('supplier:edit') || auth('supplier:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditSupplier(scope.row)" v-auth="'supplier:edit'"> 编辑 </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delSupplier(scope.row)" v-auth="'supplier:delete'"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
<script lang="ts" setup="" name="supplier">
  ...
  const openAddSupplier = () => {
    editSupplierTitle.value = '添加供应商资料';
    editDialogRef.value.openDialog({});
  };

  // 打开打印页面
  const openPrintSupplier = async (row: any) => {
    printSupplierTitle.value = '打印供应商资料';
  }
  
  // 打开编辑页面
  const openEditSupplier = (row: any) => {
    editSupplierTitle.value = '编辑供应商资料';
