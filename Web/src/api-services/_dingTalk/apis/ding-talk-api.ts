...
export const DingTalkApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet: async (body: GetDingTalkCurrentEmployeesListInput, accessToken: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/api/dingTalk/dingTalkCurrentEmployeesList/{access_token}`.replace(`{${'access_token'}}`, encodeURIComponent(String(accessToken)));
		 ...
		 * @throws {RequiredError}
		 */
		apiDingTalkDingTalkCurrentEmployeesRosterListAccessTokenGet: async (
			body: GetDingTalkCurrentEmployeesRosterListInput,
			accessToken: string,
			...
			const localVarPath = `/api/dingTalk/dingTalkCurrentEmployeesRosterList/{access_token}`.replace(`{${'access_token'}}`, encodeURIComponent(String(accessToken)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, 'https://example.com');
			let baseOptions;
			if (configuration) {
		...
		apiDingTalkDingTalkSendInteractiveCardsTokenPost: async (token: string, body?: DingTalkSendInteractiveCardsInput, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/api/dingTalk/dingTalkSendInteractiveCards/{token}`.replace(`{${'token'}}`, encodeURIComponent(String(token)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, 'https://example.com');
			let baseOptions;
			if (configuration) {
...
export const DingTalkApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet(
			body: GetDingTalkCurrentEmployeesListInput,
			accessToken: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultDingTalkBaseResponseGetDingTalkCurrentEmployeesListOutput>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiDingTalkDingTalkCurrentEmployeesRosterListAccessTokenGet(
			body: GetDingTalkCurrentEmployeesRosterListInput,
			accessToken: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultDingTalkBaseResponseListDingTalkEmpRosterFieldVo>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiDingTalkDingTalkSendInteractiveCardsTokenPost(
			token: string,
			body?: DingTalkSendInteractiveCardsInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultDingTalkSendInteractiveCardsOutput>>> {
...
export const DingTalkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet(
			...
			accessToken: string,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultDingTalkBaseResponseGetDingTalkCurrentEmployeesListOutput>> {
			return DingTalkApiFp(configuration)
				.apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet(body, accessToken, options)
		...
		async apiDingTalkDingTalkCurrentEmployeesRosterListAccessTokenGet(
			...
			accessToken: string,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultDingTalkBaseResponseListDingTalkEmpRosterFieldVo>> {
			return DingTalkApiFp(configuration)
				.apiDingTalkDingTalkCurrentEmployeesRosterListAccessTokenGet(body, accessToken, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiDingTalkDingTalkSendInteractiveCardsTokenPost(
			...
			body?: DingTalkSendInteractiveCardsInput,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultDingTalkSendInteractiveCardsOutput>> {
			return DingTalkApiFp(configuration)
				.apiDingTalkDingTalkSendInteractiveCardsTokenPost(token, body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiDingTalkDingTalkTokenGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultGetDingTalkTokenOutput>> {
			return DingTalkApiFp(configuration)
				.apiDingTalkDingTalkTokenGet(options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class DingTalkApi extends BaseAPI {
	 ...
	 */
	public async apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet(
		body: GetDingTalkCurrentEmployeesListInput,
		accessToken: string,
		options?: AxiosRequestConfig
	): Promise<AxiosResponse<AdminResultDingTalkBaseResponseGetDingTalkCurrentEmployeesListOutput>> {
		return DingTalkApiFp(this.configuration)
			.apiDingTalkDingTalkCurrentEmployeesListAccessTokenGet(body, accessToken, options)
	 ...
	 * @memberof DingTalkApi
	 */
	public async apiDingTalkDingTalkCurrentEmployeesRosterListAccessTokenGet(
		body: GetDingTalkCurrentEmployeesRosterListInput,
		accessToken: string,
		options?: AxiosRequestConfig
	): Promise<AxiosResponse<AdminResultDingTalkBaseResponseListDingTalkEmpRosterFieldVo>> {
	 ...
	 * @memberof DingTalkApi
	 */
	public async apiDingTalkDingTalkSendInteractiveCardsTokenPost(
		token: string,
		body?: DingTalkSendInteractiveCardsInput,
		options?: AxiosRequestConfig
	): Promise<AxiosResponse<AdminResultDingTalkSendInteractiveCardsOutput>> {
