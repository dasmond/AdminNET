...
export const SysLogVisApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysLogVisPagePost(
			body?: PageLogInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListSysLogVis>>> {
...
export const SysLogVisApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiSysLogVisClearPost(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysLogVisApiFp(configuration)
				.apiSysLogVisClearPost(options)
		...
		async apiSysLogVisPagePost(body?: PageLogInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSqlSugarPagedListSysLogVis>> {
			return SysLogVisApiFp(configuration)
				.apiSysLogVisPagePost(body, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SysLogVisApi extends BaseAPI {
	...
	public async apiSysLogVisClearPost(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
		return SysLogVisApiFp(this.configuration)
			.apiSysLogVisClearPost(options)
