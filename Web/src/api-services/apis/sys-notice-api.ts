...
export const SysNoticeApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		apiSysNoticePageReceivedGet: async (
			title?: string,
			type?: NoticeTypeEnum,
			page?: number,
			pageSize?: number,
			...
			keyword?: string,
			filterLogic?: FilterLogicEnum,
			filterFilters?: Array<Filter>,
			filterField?: string,
...
export const SysNoticeApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysNoticePagePost(
			body?: PageNoticeInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListSysNotice>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysNoticePageReceivedGet(
			title?: string,
			type?: NoticeTypeEnum,
			page?: number,
			pageSize?: number,
			...
			filterValue?: any,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListSysNoticeUser>>> {
			const localVarAxiosArgs = await SysNoticeApiAxiosParamCreator(configuration).apiSysNoticePageReceivedGet(
				title,
				type,
				page,
				pageSize,
...
export const SysNoticeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiSysNoticeAddPost(body?: AddNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticeAddPost(body, options)
		...
		async apiSysNoticeDeletePost(body?: DeleteNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticeDeletePost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysNoticePagePost(body?: PageNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSqlSugarPagedListSysNotice>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticePagePost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysNoticePageReceivedGet(
			...
			filterValue?: any,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultSqlSugarPagedListSysNoticeUser>> {
			return SysNoticeApiFp(configuration)
		...
		async apiSysNoticePublicPost(body?: NoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticePublicPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysNoticeSetReadPost(body?: NoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticeSetReadPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysNoticeUnReadListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysNotice>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticeUnReadListGet(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysNoticeUpdatePost(body?: UpdateNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysNoticeApiFp(configuration)
				.apiSysNoticeUpdatePost(body, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SysNoticeApi extends BaseAPI {
	...
	public async apiSysNoticeAddPost(body?: AddNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
		return SysNoticeApiFp(this.configuration)
			.apiSysNoticeAddPost(body, options)
	 ...
	 * @memberof SysNoticeApi
	 */
	public async apiSysNoticePageReceivedGet(
		title?: string,
		type?: NoticeTypeEnum,
		page?: number,
		pageSize?: number,
