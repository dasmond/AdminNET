...
export const SysLogDiffApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysLogDiffPagePost(
			body?: PageLogInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListSysLogDiff>>> {
...
export const SysLogDiffApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiSysLogDiffClearPost(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysLogDiffApiFp(configuration)
				.apiSysLogDiffClearPost(options)
		...
		async apiSysLogDiffPagePost(body?: PageLogInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSqlSugarPagedListSysLogDiff>> {
			return SysLogDiffApiFp(configuration)
				.apiSysLogDiffPagePost(body, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SysLogDiffApi extends BaseAPI {
	...
	public async apiSysLogDiffClearPost(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
		return SysLogDiffApiFp(this.configuration)
			.apiSysLogDiffClearPost(options)
