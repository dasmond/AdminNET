...
export const SysWechatPayApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		apiSysWechatPayPayInfoFromWechatTradeIdGet: async (tradeId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/api/sysWechatPay/payInfoFromWechat/{tradeId}`.replace(`{${'tradeId'}}`, encodeURIComponent(String(tradeId)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, 'https://example.com');
			let baseOptions;
			if (configuration) {
		...
		apiSysWechatPayPayInfoTradeIdGet: async (tradeId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/api/sysWechatPay/payInfo/{tradeId}`.replace(`{${'tradeId'}}`, encodeURIComponent(String(tradeId)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, 'https://example.com');
			let baseOptions;
			if (configuration) {
		...
		apiSysWechatPayRefundInfoFromWechatRefundIdGet: async (refundId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			...
			const localVarPath = `/api/sysWechatPay/refundInfoFromWechat/{refundId}`.replace(`{${'refundId'}}`, encodeURIComponent(String(refundId)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, 'https://example.com');
			let baseOptions;
			if (configuration) {
...
export const SysWechatPayApiFp = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayGenerateParametersForJsapiPayPost(
			body?: WechatPayParaInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultWechatPayParaOutput>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayPagePost(
			body?: WechatPayPageInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListSysWechatPay>>> {
		...
		async apiSysWechatPayPayInfoFromWechatTradeIdGet(
			tradeId: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSysWechatPay>>> {
		...
		async apiSysWechatPayPayPartnerTransactionPost(
			body?: WechatPayTransactionInput,
			options?: AxiosRequestConfig
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayPayTransactionNativePost(
			body?: WechatPayTransactionInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultObject>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayPayTransactionPost(
			body?: WechatPayTransactionInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultWechatPayTransactionOutput>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayRefundDomesticPost(
			body?: WechatPayRefundDomesticInput,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultObject>>> {
		 ...
		 * @throws {RequiredError}
		 */
		async apiSysWechatPayRefundInfoFromWechatRefundIdGet(
			refundId: string,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSysWechatRefund>>> {
...
export const SysWechatPayApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiSysWechatPayGenerateParametersForJsapiPayPost(body?: WechatPayParaInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultWechatPayParaOutput>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayGenerateParametersForJsapiPayPost(body, options)
		...
		async apiSysWechatPayListRefundPost(body?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysWechatRefund>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayListRefundPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPagePost(body?: WechatPayPageInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSqlSugarPagedListSysWechatPay>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPagePost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayCallBackPost(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultWechatPayOutput>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayCallBackPost(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayInfoFromWechatTradeIdGet(tradeId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSysWechatPay>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayInfoFromWechatTradeIdGet(tradeId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayInfoTradeIdGet(tradeId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSysWechatPay>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayInfoTradeIdGet(tradeId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayPartnerCallBackPost(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayPartnerCallBackPost(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayPartnerTransactionPost(body?: WechatPayTransactionInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultObject>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayPartnerTransactionPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayTransactionNativePost(body?: WechatPayTransactionInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultObject>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayTransactionNativePost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayPayTransactionPost(body?: WechatPayTransactionInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultWechatPayTransactionOutput>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayPayTransactionPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayRefundDomesticPost(body?: WechatPayRefundDomesticInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultObject>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayRefundDomesticPost(body, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		async apiSysWechatPayRefundInfoFromWechatRefundIdGet(refundId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSysWechatRefund>> {
			return SysWechatPayApiFp(configuration)
				.apiSysWechatPayRefundInfoFromWechatRefundIdGet(refundId, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SysWechatPayApi extends BaseAPI {
	...
	public async apiSysWechatPayGenerateParametersForJsapiPayPost(body?: WechatPayParaInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultWechatPayParaOutput>> {
		return SysWechatPayApiFp(this.configuration)
			.apiSysWechatPayGenerateParametersForJsapiPayPost(body, options)
