...
export const SysCodeGenConfigApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 */
		apiSysCodeGenConfigDetailGet: async (
			id?: number,
			codeGenId?: number,
			columnName?: string,
			propertyName?: string,
		 ...
		 * @throws {RequiredError}
		 */
		apiSysCodeGenConfigListGet: async (
			id?: number,
			codeGenId?: number,
			columnName?: string,
			propertyName?: string,
...
export const SysCodeGenConfigApiFp = function (configuration?: Configuration) {
	return {
		...
		async apiSysCodeGenConfigDetailGet(
			...
			orderNo?: number,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSysCodeGenConfig>>> {
			const localVarAxiosArgs = await SysCodeGenConfigApiAxiosParamCreator(configuration).apiSysCodeGenConfigDetailGet(
				id,
				codeGenId,
				columnName,
				propertyName,
		...
		async apiSysCodeGenConfigListGet(
			...
			orderNo?: number,
			options?: AxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListCodeGenConfig>>> {
			const localVarAxiosArgs = await SysCodeGenConfigApiAxiosParamCreator(configuration).apiSysCodeGenConfigListGet(
				id,
				codeGenId,
				columnName,
				propertyName,
...
export const SysCodeGenConfigApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	return {
		...
		async apiSysCodeGenConfigDetailGet(
			...
			orderNo?: number,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultSysCodeGenConfig>> {
			return SysCodeGenConfigApiFp(configuration)
		...
		async apiSysCodeGenConfigListGet(
			...
			orderNo?: number,
			options?: AxiosRequestConfig
		): Promise<AxiosResponse<AdminResultListCodeGenConfig>> {
			return SysCodeGenConfigApiFp(configuration)
		...
		async apiSysCodeGenConfigUpdatePost(body?: Array<CodeGenConfig>, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
			return SysCodeGenConfigApiFp(configuration)
				.apiSysCodeGenConfigUpdatePost(body, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class SysCodeGenConfigApi extends BaseAPI {
	...
	public async apiSysCodeGenConfigDetailGet(
		...
		return SysCodeGenConfigApiFp(this.configuration)
			.apiSysCodeGenConfigDetailGet(
				id,
				codeGenId,
				columnName,
