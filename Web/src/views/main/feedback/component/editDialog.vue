...
<script lang="ts" setup>
	...
	import { addFeedback, updateFeedback, detailFeedback } from "/@/api/main/feedback";
	...
	const openDialog = async (row: any) => {
		...
		if (rowData.id)
			ruleForm.value = (await detailFeedback(rowData.id)).data.result;
		else
