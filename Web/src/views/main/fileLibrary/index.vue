  ...
  <div class="fileLibrary-container">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="文件号">
              <el-input v-model="queryParams.fileNumber" clearable="" placeholder="请输入文件号"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="标准文件号">
              <el-input v-model="queryParams.standardFileNumber" clearable="" placeholder="请输入标准文件号"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="所属管理部门">
              <el-input v-model="queryParams.affiliation" clearable="" placeholder="请输入所属管理部门"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="文件级别">
              <el-input-number v-model="queryParams.level"  clearable="" placeholder="请输入文件级别"/>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="区分类型">
              <el-input-number v-model="queryParams.distinguishTypes"  clearable="" placeholder="请输入区分类型"/>
              
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="showAdvanceQueryUI">
            <el-form-item label="文件版本号">
              <el-input-number v-model="queryParams.fileVersionNumber"  clearable="" placeholder="请输入文件版本号"/>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="mb10">
            <el-form-item>
              <el-button-group>
                <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'fileLibrary:page'"> 查询 </el-button>
              ...
              <el-button-group style="margin-left:20px">
                <el-button type="primary" icon="ele-Plus" @click="openAddFileLibrary" v-auth="'fileLibrary:add'"> 新增 </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column prop="fileNumber" label="文件号" width="140"  show-overflow-tooltip="" />
        <el-table-column prop="standardFileNumber" label="标准文件号" width="140"  show-overflow-tooltip="" />
        <el-table-column prop="affiliation" label="所属管理部门" width="90"  show-overflow-tooltip="" />
        <el-table-column prop="level" label="文件级别" width="140"  show-overflow-tooltip="" />
        ...
        <el-table-column prop="distinguishTypes" label="区分类型" width="140"  show-overflow-tooltip="" />
        <el-table-column prop="fileVersionNumber" label="文件版本号" width="140"  show-overflow-tooltip="" />
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip="" v-if="auth('fileLibrary:edit') || auth('fileLibrary:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditFileLibrary(scope.row)" v-auth="'fileLibrary:edit'"> 编辑 </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delFileLibrary(scope.row)" v-auth="'fileLibrary:delete'"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
	...
	/>
      <printDialog
        ref="printDialogRef"
        :title="printFileLibraryTitle"
        @reloadTable="handleQuery" />
      <editDialog
        ref="editDialogRef"
        :title="editFileLibraryTitle"
        @reloadTable="handleQuery"
      />
    </el-card>
  </div>
...
<script lang="ts" setup="" name="fileLibrary">
  import { ref } from "vue";
  ...
  import editDialog from '/@/views/main/fileLibrary/component/editDialog.vue'
  import { pageFileLibrary, deleteFileLibrary } from '/@/api/main/fileLibrary';
  ...
  const printFileLibraryTitle = ref("");
  const editFileLibraryTitle = ref("");
  ...
  const handleQuery = async () => {
    loading.value = true;
    var res = await pageFileLibrary(Object.assign(queryParams.value, tableParams.value));
  ...
  // 打开新增页面
  const openAddFileLibrary = () => {
    editFileLibraryTitle.value = '添加文件库';
    editDialogRef.value.openDialog({});
  };

  // 打开打印页面
  const openPrintFileLibrary = async (row: any) => {
    printFileLibraryTitle.value = '打印文件库';
  }
  
  // 打开编辑页面
  const openEditFileLibrary = (row: any) => {
    editFileLibraryTitle.value = '编辑文件库';
    editDialogRef.value.openDialog(row);
  };

  // 删除
  const delFileLibrary = (row: any) => {
