      ...
      >
        ...
        <el-table-column prop="sysNotice.content" label="内容" show-overflow-tooltip>
          <template #default="scope">
            {{ removeHtml(scope.row.sysNotice.content) }}
          </template>
        </el-table-column>
        <el-table-column
          prop="sysNotice.type"
        ...
        <el-table-column
          prop="sysNotice.publicUserName"
          label="发布者"
          align="center"
          show-overflow-tooltip
        />
        <el-table-column
          prop="sysNotice.publicTime"
          label="发布时间"
          align="center"
          show-overflow-tooltip
        />
...
const handleQuery = async () => {
  state.loading = true;
  var res = await getAPI(SysNoticeApi).sysNoticePageReceivedGet(
...
const viewDetail = async (row: any) => {
  ...
  mittBus.emit(eventBusKey.setReadPost, row.sysNotice.id);
};
