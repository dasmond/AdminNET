<template>
	<div class="layout-breadcrumb-seting">
		<el-drawer :title="$t('message.layout.configTitle')" v-model="getThemeConfig.isDrawer" direction="rtl"
			destroy-on-close size="280px" @close="onDrawerClose">
			<el-scrollbar class="layout-breadcrumb-seting-bar">
				...
				<!-- 分栏设置 -->
				<el-divider content-position="center" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">{{
				...
				<div class="layout-breadcrumb-seting-bar-flex"
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-color-picker v-model="getThemeConfig.columnsMenuBar" size="default"
							@change="onBgColorPickerChange('columnsMenuBar')" :disabled="getThemeConfig.layout !== 'columns'">
						</el-color-picker>
					</div>
				</div>
				<div class="layout-breadcrumb-seting-bar-flex"
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14"
					:style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.layout.twoIsColumnsMenuBarColorGradual')
						}}</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14"
					:style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.layout.twoIsColumnsMenuHoverPreload') }}
					</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
				...
				<div class="layout-breadcrumb-seting-bar-flex"
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isCollapse" :disabled="getThemeConfig.layout === 'transverse'"
							size="small" @change="onThemeConfigChange"></el-switch>
					</div>
				</div>
				<div class="layout-breadcrumb-seting-bar-flex mt15"
					:style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15"
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isClassicSplitMenu" :disabled="getThemeConfig.layout !== 'classic'"
							size="small" @change="onClassicSplitMenuChange"> </el-switch>
					</div>
				</div>
				<div class="layout-breadcrumb-seting-bar-flex mt15">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt11">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-input-number v-model="getThemeConfig.lockScreenTime" controls-position="right" :min="1" :max="9999"
							@change="setLocalThemeConfig" size="small" style="width: 90px; margin-right: 1px">
						</el-input-number>
					</div>
				</div>
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: state.isMobile ? 0.5 : 1 }">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isSortableTagsView" :disabled="state.isMobile ? true : false"
							size="small" @change="onSortableTagsViewChange"></el-switch>
					</div>
				</div>
				<div class="layout-breadcrumb-seting-bar-flex mt15">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-input v-model="getThemeConfig.watermarkText" size="small" style="width: 90px; margin-right: 1px"
							@input="onWatermarkTextInput" disabled></el-input>
					</div>
				</div>
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-select v-model="getThemeConfig.tagsStyle" placeholder="请选择" size="small"
							style="width: 90px; margin-right: 1px" @change="setLocalThemeConfig">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-select v-model="getThemeConfig.animation" placeholder="请选择" size="small"
							style="width: 90px; margin-right: 1px" @change="setLocalThemeConfig">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15"
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-select v-model="getThemeConfig.columnsAsideStyle" placeholder="请选择" size="small"
							style="width: 90px; margin-right: 1px" :disabled="getThemeConfig.layout !== 'columns' ? true : false"
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15 mb27"
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-select v-model="getThemeConfig.columnsAsideLayout" placeholder="请选择" size="small"
							style="width: 90px; margin-right: 1px" :disabled="getThemeConfig.layout !== 'columns' ? true : false"
							@change="setLocalThemeConfig">
